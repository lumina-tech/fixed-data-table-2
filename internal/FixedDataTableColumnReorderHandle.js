...
var FixedDataTableColumnReorderHandle = /*#__PURE__*/ (function (
  ...
  function FixedDataTableColumnReorderHandle() {
    ...
    _defineProperty(
      ...
      function (event) {
        ...
        _this._mouseMoveTracker = new _DOMMouseMoveTracker['default'](
          _this._onMove,
          _this._onColumnReorderEnd,
          document.body,
    ...
    _defineProperty(
      ...
      function (
        ...
        _this._distance =
          _this.state.dragDistance + deltaX * (_this.props.isRTL ? -1 : 1);
      }
    );
