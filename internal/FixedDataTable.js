...
var _debounceCore = _interopRequireDefault(
  require('././vendor_upstream/core/debounceCore')
);

var _joinClasses = _interopRequireDefault(
  require('././vendor_upstream/core/joinClasses')
);

var _shallowEqual = _interopRequireDefault(
  require('././vendor_upstream/core/shallowEqual')
);

var _ReactWheelHandler = _interopRequireDefault(
  require('././vendor_upstream/dom/ReactWheelHandler')
);

var _ariaAttributes = _interopRequireDefault(
  require('././selectors/ariaAttributes')
);

var _columnTemplates = _interopRequireDefault(
  require('././selectors/columnTemplates')
);

var _scrollbarsVisible3 = _interopRequireDefault(
  require('././selectors/scrollbarsVisible')
);

var _tableHeights = _interopRequireDefault(
  require('././selectors/tableHeights')
);

var _ColumnResizerLine = _interopRequireDefault(
  require('././ColumnResizerLine')
);

var _FixedDataTableBufferedRows = _interopRequireDefault(
  require('././FixedDataTableBufferedRows')
);

var _FixedDataTableEventHelper = _interopRequireDefault(
  require('././FixedDataTableEventHelper')
);

var _FixedDataTableRow = _interopRequireDefault(
  require('././FixedDataTableRow')
);

var _ReactTouchHandler = _interopRequireDefault(
  require('././ReactTouchHandler')
);
...
var FixedDataTable = /*#__PURE__*/ (function (_React$Component) {
  ...
  function FixedDataTable(_props) {
    ...
    _defineProperty(
      ...
      {
        var _scrollbarsVisible = (0, _scrollbarsVisible3['default'])(
            _this.props
          ),
        ...
        return /*#__PURE__*/ _react['default'].createElement(
          _FixedDataTableBufferedRows['default'],
          {
    ...
    _defineProperty(
      ...
      function (
        ...
        var coordinates =
          _FixedDataTableEventHelper['default'].getCoordinatesFromEvent(event);
    ...
    _defineProperty(
      ...
      function (
        ...
        var ownerHeightChanged =
          ownerHeight !== oldOwnerHeight &&
          !(
            (0, _isNaN['default'])(ownerHeight) &&
            (0, _isNaN['default'])(oldOwnerHeight)
          );
    ...
    _this._didScrollStop = (0, _debounceCore['default'])(
      _this._didScrollStopSync,
      200,
      _assertThisInitialized(_this)
    );
    _this._onKeyDown = _this._onKeyDown.bind(_assertThisInitialized(_this));
    _this._wheelHandler = new _ReactWheelHandler['default'](
      _this._onScroll,
      _this._shouldHandleWheelX,
      _this._shouldHandleWheelY,
      _this.props.isRTL,
      _this.props.stopScrollDefaultHandling,
      _this.props.stopScrollPropagation
    );
    _this._touchHandler = new _ReactTouchHandler['default'](
      _this._onScroll,
      _this._shouldHandleTouchX,
      _this._shouldHandleTouchY,
      _this.props.stopScrollDefaultHandling,
      _this.props.stopScrollPropagation
    );
    return _this;
  ...
  _createClass(FixedDataTable, [
    ...
    },
    {
      ...
      value: function render() /*object*/
      {
        ...
        var _columnTemplatesSelec = (0, _columnTemplates['default'])(
            this.props
          ),
        ...
        var _scrollbarsVisible2 = (0, _scrollbarsVisible3['default'])(
            this.props
          ),
          scrollEnabledX = _scrollbarsVisible2.scrollEnabledX,
          scrollEnabledY = _scrollbarsVisible2.scrollEnabledY;

        var onColumnReorder = onColumnReorderEndCallback
        ...
        if (groupHeaderHeight > 0) {
          groupHeader = /*#__PURE__*/ _react['default'].createElement(
            _FixedDataTableRow['default'],
            {
              key: 'group_header',
              ariaRowIndex: ariaGroupHeaderIndex,
              isHeaderOrFooter: true,
              isScrolling: scrolling,
              className: (0, _joinClasses['default'])(
                (0, _cx['default'])('fixedDataTableLayout/header'),
                (0, _cx['default'])('public/fixedDataTable/header')
              ),
              width: width,
        ...
        var dragKnob = /*#__PURE__*/ _react['default'].createElement(
          _ColumnResizerLine['default'],
          {
        ...
        if (footerHeight) {
          footer = /*#__PURE__*/ _react['default'].createElement(
            _FixedDataTableRow['default'],
            {
              ...
              isScrolling: scrolling,
              className: (0, _joinClasses['default'])(
                (0, _cx['default'])('fixedDataTableLayout/footer'),
                (0, _cx['default'])('public/fixedDataTable/footer')
              ),
              width: width,
              height: footerHeight,
              index: -1,
        ...
        if (scrollY) {
          topShadow = /*#__PURE__*/ _react['default'].createElement('div', {
            className: (0, _joinClasses['default'])(
              (0, _cx['default'])('fixedDataTableLayout/topShadow'),
              (0, _cx['default'])('public/fixedDataTable/topShadow')
            ),
            style: {
              top: bodyOffsetTop,
            },
        ...
        if (ownerScrollAvailable || scrollY < maxScrollY) {
          bottomShadow = /*#__PURE__*/ _react['default'].createElement('div', {
            className: (0, _joinClasses['default'])(
              (0, _cx['default'])('fixedDataTableLayout/bottomShadow'),
              (0, _cx['default'])('public/fixedDataTable/bottomShadow')
            ),
            style: {
              top: footOffsetTop,
            },
        ...
        if (this.props.isRTL) {
          tableClassName = (0, _joinClasses['default'])(
            tableClassName,
          ...
          _extends(
            {
              className: (0, _joinClasses['default'])(
                tableClassName,
                (0, _cx['default'])('fixedDataTableLayout/main'),
                (0, _cx['default'])('public/fixedDataTable/main')
              ),
              role: 'grid',
...
_defineProperty(FixedDataTable, 'propTypes', {
   ...
   * first argument.
   */
  rowExpanded: _propTypes['default'].oneOfType([
