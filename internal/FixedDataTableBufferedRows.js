  ...
  _createClass(FixedDataTableBufferedRows, [
    ...
    },
    {
      ...
      value: function renderRow(_ref) /*object*/
      {
        ...
        var rowClassNameGetter =
          props.rowClassNameGetter || _emptyFunction['default'];
        ...
        if (!fake) {
          ...
          rowProps.className = (0, _joinClasses['default'])(
            rowClassNameGetter(rowIndex),
            (0, _cx['default'])('public/fixedDataTable/bodyRow'),
            (0, _cx['default'])({
        ...
        var visible = (0, _inRange['default'])(
          rowIndex,
