...
var _FixedDataTableCellGroup = _interopRequireDefault(
  require('././FixedDataTableCellGroup')
);

var _FixedDataTableTranslateDOMPosition = _interopRequireDefault(
  require('././FixedDataTableTranslateDOMPosition')
);
  ...
  function FixedDataTableRowImpl() {
    ...
    _defineProperty(
      ...
      ) /*?object*/
      {
        if (_this.props.rowExpanded) {
          ...
          if (
            /*#__PURE__*/ _react['default'].isValidElement(
              _this.props.rowExpanded
            )
          ) {
            rowExpanded = /*#__PURE__*/ _react['default'].cloneElement(
              _this.props.rowExpanded,
              rowExpandedProps
            );
    ...
    _defineProperty(
      ...
      ) /*?object*/
      {
        ...
        var dividerHeight = _this.props.cellGroupWrapperHeight
  ...
  _createClass(FixedDataTableRowImpl, [
    ...
    },
    {
      ...
      value: function render() /*object*/
      {
        ...
        var fixedColumnsWidth = (0, _widthHelper.sumPropWidths)(
          this.props.fixedColumns
        );

        var fixedColumns = /*#__PURE__*/ _react['default'].createElement(
          _FixedDataTableCellGroup['default'],
          {
            key: 'fixed_cells',
        ...
        var columnsLeftShadow =
          this._renderColumnsLeftShadow(fixedColumnsWidth);

        var fixedRightColumnsWidth = (0, _widthHelper.sumPropWidths)(
        ...
        var fixedRightColumns = /*#__PURE__*/ _react['default'].createElement(
          _FixedDataTableCellGroup['default'],
          {
        ...
        var scrollableColumns = /*#__PURE__*/ _react['default'].createElement(
          _FixedDataTableCellGroup['default'],
          {
        ...
        var scrollableColumnsWidth = (0, _widthHelper.sumPropWidths)(
        ...
        if (this.props.showScrollbarY) {
          ...
          scrollbarSpacer = /*#__PURE__*/ _react['default'].createElement(
            'div',
            {
              style: spacerStyles,
  ...
  _createClass(FixedDataTableRow, [
    ...
    },
    {
      ...
      value: function render() /*object*/
      {
        ...
        (0, _FixedDataTableTranslateDOMPosition['default'])(
          style,
          0,
          offsetTop,
          this._initialRender,
