...
var _FixedDataTableCellDefaultDeprecated = _interopRequireDefault(
  require('././FixedDataTableCellDefaultDeprecated')
);

var _FixedDataTableColumnReorderHandle = _interopRequireDefault(
  require('././FixedDataTableColumnReorderHandle')
);
      ...
      },
      {
        ...
        value: function render() /*object*/
        {
          ...
          if (this.state.isReorderingThisColumn) {
            ...
            style.transform = 'translateX('.concat(
          ...
          var className = (0, _joinClasses['default'])(
            (0, _cx['default'])({
              ...
              'public/fixedDataTableCell/hasReorderHandle':
          ...
          if (props.onColumnResize) {
            ...
            columnResizerComponent = /*#__PURE__*/ _react[
              'default'
            ].createElement(
              'div',
              {
          ...
          if (props.onColumnReorder) {
            //header row
            columnReorderComponent = /*#__PURE__*/ _react[
              'default'
            ].createElement(
              _FixedDataTableColumnReorderHandle['default'],
              _extends(
                {
          ...
          if (/*#__PURE__*/ _react['default'].isValidElement(props.cell)) {
            content = /*#__PURE__*/ _react['default'].cloneElement(
              props.cell,
              cellProps
            );
            ...
            content = /*#__PURE__*/ _react['default'].createElement(
              _FixedDataTableCellDefaultDeprecated['default'],
              cellProps,
              props.cell
            );
          }
    ...
    [
      {
        ...
        value: function getDerivedStateFromProps(nextProps, prevState) {
          ...
          var farthestPossiblePoint =
            nextProps.columnGroupWidth -
            nextProps.columnReorderingData.columnWidth; // ensure the cell isn't being dragged out of the column group
          ...
          if (
            nextProps.columnKey === nextProps.columnReorderingData.columnKey
          ) {
          ...
          var cellIsBeforeOneBeingDragged =
            reorderCellCenter > centerOfThisColumn;
          var cellWasOriginallyBeforeOneBeingDragged =
            originalLeft > nextProps.left;
            ...
            if (reorderCellLeft < centerOfThisColumn) {
              ...
              if (cellWasOriginallyBeforeOneBeingDragged) {
                newState.displacement =
                  nextProps.columnReorderingData.columnWidth;
              } else {
                newState.displacement = 0;
              }
            }
          ...
          if (changedPosition) {
            if (cellIsBeforeOneBeingDragged) {
              if (!nextProps.columnReorderingData.columnAfter) {
                nextProps.columnReorderingData.columnAfter =
                  nextProps.columnKey;
              }
            } else {
...
_defineProperty(FixedDataTableCell, 'propTypes_DISABLED_FOR_PERFORMANCE', {
  ...
  columnKey: _propTypes['default'].oneOfType([
    _propTypes['default'].string,
