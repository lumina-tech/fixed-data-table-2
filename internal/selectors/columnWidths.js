...
var _shallowEqualSelector = _interopRequireDefault(
  require('./../helper/shallowEqualSelector')
);

var _widthHelper = require('./../helper/widthHelper');

var _scrollbarsVisible = _interopRequireDefault(
  require('././scrollbarsVisible')
);
...
function columnWidths(
  ...
  var availableScrollWidth =
    viewportWidth -
    (0, _widthHelper.getTotalWidth)(fixedColumns) -
    (0, _widthHelper.getTotalWidth)(fixedRightColumns);
  var maxScrollX = Math.max(
    0,
    (0, _widthHelper.getTotalWidth)(newColumnProps) - viewportWidth
  );
  return {
...
function flexWidths(columnGroupProps, columnProps, viewportWidth) {
  ...
  var newColumnGroupProps = (0, _map['default'])(
    columnGroupProps,
    function (columnGroup, idx) {
...
var _default = (0, _shallowEqualSelector['default'])(
  [
    function (state) {
