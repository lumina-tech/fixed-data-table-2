...
var columnActions = _interopRequireWildcard(
  require('././actions/columnActions')
);

var scrollActions = _interopRequireWildcard(
  require('././actions/scrollActions')
);

var _FixedDataTable = _interopRequireDefault(require('././FixedDataTable'));

var _FixedDataTableStore = _interopRequireDefault(
  require('././FixedDataTableStore')
);

var _Scrollbar = _interopRequireDefault(require('././plugins/Scrollbar'));

var _ScrollContainer = _interopRequireDefault(
  require('././plugins/ScrollContainer')
);
...
var FixedDataTableContainer = /*#__PURE__*/ (function (_React$Component) {
  ...
  function FixedDataTableContainer(props) {
    ...
    _this.scrollActions = (0, _redux.bindActionCreators)(
      scrollActions,
      _this.reduxStore.dispatch
    );
    _this.columnActions = (0, _redux.bindActionCreators)(
      columnActions,
      _this.reduxStore.dispatch
    );
  ...
  _createClass(FixedDataTableContainer, [
    ...
    },
    {
      ...
      value: function render() {
        var fdt = /*#__PURE__*/ _react['default'].createElement(
          _FixedDataTable['default'],
    ...
    },
    {
      ...
      value: function getBoundState() {
        ...
        var boundState = (0, _pick['default'])(state, [
          'columnGroupProps',
          'columnProps',
