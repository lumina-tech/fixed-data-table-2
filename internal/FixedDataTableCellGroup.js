...
var _FixedDataTableCell = _interopRequireDefault(
  require('././FixedDataTableCell')
);
...
var FixedDataTableCellGroupImpl = /*#__PURE__*/ (function (_React$Component) {
  ...
  function FixedDataTableCellGroupImpl(props) {
    ...
    _defineProperty(
      ...
      {
        var cellIsResizable =
          columnProps.isResizable && _this.props.onColumnResize;
        var onColumnResize = cellIsResizable
        ...
        var onColumnReorder = cellIsReorderable
          ? _this.props.onColumnReorder
          : null;
        var className = columnProps.cellClassName;
        var pureRendering = columnProps.pureRendering || false;
        return /*#__PURE__*/ _react['default'].createElement(
          _FixedDataTableCell['default'],
          {
      ...
      value: function render() /*object*/
      {
        ...
        var isColumnReordering =
          ...
          columns.reduce(function (acc, column) {
            return (
              acc ||
              props.columnReorderingData.columnKey === column.props.columnKey
            );
          }, false);
        ...
        for (var i = 0, j = columns.length; i < j; i++) {
          ...
          var recyclable =
            columnProps.allowCellsRecycling && !isColumnReordering;
        ...
        return /*#__PURE__*/ _react['default'].createElement(
          'div',
          {
            className: (0, _cx['default'])(
              'fixedDataTableCellGroupLayout/cellGroup'
            ),
            style: style,
          },
          cells
  ...
  function FixedDataTableCellGroup() {
    ...
    _defineProperty(
      ...
      function (
        ...
        _this2.props.onColumnResize &&
          _this2.props.onColumnResize(
            _this2.props.offsetLeft,
            left - _this2.props.left + width,
            width,
            minWidth,
            maxWidth,
            columnKey,
