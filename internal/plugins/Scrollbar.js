...
var _emptyFunction = _interopRequireDefault(
  require('./../vendor_upstream/core/emptyFunction')
);
...
var _DOMMouseMoveTracker = _interopRequireDefault(
  require('./../vendor_upstream/dom/DOMMouseMoveTracker')
);
...
var FACE_MARGIN = parseInt(
  (0, _cssVar['default'])('scrollbar-face-margin'),
  10
);
...
var Scrollbar = /*#__PURE__*/ (function (_React$PureComponent) {
  ...
  function Scrollbar(_props) {
    ...
    _defineProperty(
      ...
      {
        var nextState = _this._calculateState(
    ...
    _defineProperty(
      ...
      ) /*object*/
      {
        ...
        var isDragging = _this._mouseMoveTracker
    ...
    _defineProperty(
      ...
      function (
        ...
        if (event.target !== _this._faceRef) {
          ...
          var position = _this.state.isHorizontal
            ? nativeEvent.offsetX ||
              nativeEvent.layerX ||
    ...
    _defineProperty(
      ...
      function (
        ...
        var props = _this.props;
        var delta = _this.state.isHorizontal
  ...
  _createClass(Scrollbar, [
    ...
    },
    {
      ...
      value: function render() /*?object*/
      {
        ...
        if (this.props.trackColor === 'gray') {
          mainStyle.backgroundColor = (0, _cssVar['default'])(
    ...
    },
    {
      ...
      value: function componentDidMount() {
        ...
        this._wheelHandler = new _ReactWheelHandler['default'](
          onWheel,
        ...
        this._mouseMoveTracker = new _DOMMouseMoveTracker['default'](
          this._onMouseMove,
