...
function _extractProps(column) {
  return (0, _pick['default'])(column.props, [
    'align',
    'allowCellsRecycling',
    'cellClassName',
    'columnKey',
...
function convertColumnElementsToData(childComponents) {
  ...
  _react['default'].Children.forEach(childComponents, function (child, index) {
    ...
    _invariant[
      'default'
    ])(child.type.__TableColumnGroup__ || child.type.__TableColumn__, 'child type should be <FixedDataTableColumn /> or <FixedDataTableColumnGroup />');
    children.push(child);
  });
  ...
  if (hasGroupHeader) {
    ...
    (0, _forEach['default'])(children, function (columnGroupElement, index) {
      ...
      _react['default'].Children.forEach(
        columnGroupElement.props.children,
        function (child) {
