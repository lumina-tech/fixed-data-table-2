...
var _BrowserSupportCore = _interopRequireDefault(
  require('././vendor_upstream/dom/BrowserSupportCore')
);

var _translateDOMPositionXY = _interopRequireDefault(
  require('././vendor_upstream/dom/translateDOMPositionXY')
);
