...
var _EventListener = _interopRequireDefault(
  require('./../stubs/EventListener')
);

var _cancelAnimationFramePolyfill = _interopRequireDefault(
  require('./../core/cancelAnimationFramePolyfill')
);

var _requestAnimationFramePolyfill = _interopRequireDefault(
  require('./../core/requestAnimationFramePolyfill')
);
  ...
  _createClass(DOMMouseMoveTracker, [
    {
      ...
      value: function captureMouseMoves(
        ...
        if (
          ...
          this._eventMoveToken = _EventListener['default'].listen(
            this._domNode,
            'mousemove',
            this._onMouseMove
          );
          this._eventUpToken = _EventListener['default'].listen(
            this._domNode,
            'mouseup',
            this._onMouseUp
          );
          this._eventLeaveToken = _EventListener['default'].listen(
            this._domNode,
            'mouseleave',
            this._onMouseEnd
          );
        ...
        if (
          ...
          this._eventTouchStartToken = _EventListener['default'].listen(
            this._domNode,
            'touchstart',
            this._onMouseMove
          );
          this._eventTouchMoveToken = _EventListener['default'].listen(
            this._domNode,
            'touchmove',
            this._onMouseMove
          );
          this._eventTouchEndToken = _EventListener['default'].listen(
            this._domNode,
            'touchend',
            this._onMouseUp
          );
        ...
        if (!this._isDragging) {
          ...
          var coordinates =
            _FixedDataTableEventHelper['default'].getCoordinatesFromEvent(
              event
            );
    ...
    },
    {
      ...
      value: function _onMouseMove(
        ...
        if (this._animationFrameID === null) {
          ...
          _requestAnimationFramePolyfill['default'])(this._didMouseMove);
        }
